...
const resourcesCopy: Record<string, ResourcesCopy> = {
  ...
  zh: {
    ...
    fieldNotesTitle: '更干净的采集笔记',
    fieldNotes: [
      {
        title: '按任务写路线，不要只按生态区写',
        body: 'Copper 路线和碎片扫描可能经过同一片海，但背包空间和氧气节奏完全不同。路线还没熟之前，把它们拆开做。',
      },
      {
        title: '故意空着格子出门',
        body: '一趟舒服的采集，从下水前就开始了。如果出门时背包已经半满，水下每捡一个东西都要纠结，节奏会被打断。',
      },
      {
        title: '稀有材料最怕补丁改动',
        body: '基础材料路线通常还能看懂，但稀有材料链在抢先体验阶段更容易变。路线突然不对劲时，先核对当前版本，再重写攻略。',
      },
    ],
    routeChecklistTitle: '好用的采集路线',
    routeChecklist: [
      '只定一个材料目标，或者一个扫描目标。',
      '有一个能讲给队友听的清楚地标。',
      '背包空间留给这趟真正要拿的东西。',
