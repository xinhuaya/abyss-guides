...
const beginnerCopy: Record<string, BeginnerCopy> = {
  ...
  zh: {
    ...
    fieldNotesTitle: '第一次下水的现场笔记',
    fieldNotes: [
      {
        title: '第一个地标是 Lifepod，不是远处风景',
        body: '如果你不打开地图或菜单就说不清 Lifepod 在哪边，那这趟已经游得太远了。第一小时先熟悉出生点附近的海底形状，再去看深处。',
      },
      {
        title: '背包吵起来之前先扫描',
        body: '满背包会让人觉得赚到了，但蓝图进度会改变下一趟路线。安全氧气线附近有碎片时，先扫完，再考虑捡普通材料。',
      },
      {
        title: '第一小时最好留下一个无聊循环',
        body: '最好的开局成果不是稀有材料，而是一条能反复跑的短路线。Copper、Silver、扫描点或基地材料，先让其中一个目标稳定下来。',
      },
    ],
    routeChecklistTitle: '继续往外推之前',
    routeChecklist: [
      '不用猜也知道回 Lifepod 的方向。',
      '至少有一个氧气备份，或者知道哪里能补氧。',
      '附近有用碎片已经扫过，不是全部留给下次。',
