...
const airTankCopy: Record<string, AirTankCopy> = {
  ...
  ja: {
    metadata: {
      title: 'Subnautica 2 酸素タンクガイド - 序盤のO2を増やす',
      description:
...
airTankCopy.zh = {
  ...
  fieldNotesTitle: '更安全的氧气笔记',
  fieldNotes: [
    {
      title: '扫描路线比挖矿路线更慢',
      body: '挖矿时你一直在移动，扫描时你会停在原地，镜头还经常背对出口。只要这趟要扫碎片或生命体，氧气预算就要加厚一点。',
    },
    {
      title: '花 Silver 前先看下一条配方',
      body: 'Silver 很容易被电子件吃掉。如果 Standard Air Tank 是下一件关键升级，先把需要的材料留出来，再做旁支装备。',
    },
    {
      title: 'Air Bladder 就当保险',
      body: '它不帅，但洞里多转错一个角时，它能把翻车变成小插曲。路线还没无聊到闭眼会跑之前，背一个不亏。',
    },
  ],
  routeChecklistTitle: 'O2 检查',
  routeChecklist: [
    '知道下一个补氧点或出口在哪里。',
    '洞穴路线至少带一个 Air Bladder。',
    '如果下一步做气瓶，Silver 不要先花光。',
    '扫描停留时间要算进额外氧气成本。',
  ],
  routeTitle: '前期 O2 路线',
  routeSteps: [
