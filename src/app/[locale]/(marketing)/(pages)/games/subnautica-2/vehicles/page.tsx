...
const copyByLocale: Record<string, VehiclesCopy> = {
  en: {
    ...
    quickAnswer:
      'The Tadpole is the vehicle to track first. Hotfix 2 specifically mentions Tadpole lights, Hammerhead behavior around the Tadpole, a teleport bug while exploring in a Tadpole, and an oxygen bug while piloting it. Unknown Worlds also says future drops will expand tools and vehicles, so treat any extra vehicle names as watch items until official pages or in-game scans support them.',
    ...
    fieldNotes: [
      ...
      },
      {
        ...
        body: 'Hotfix 2 already touched Tadpole behavior and bugs, so vehicle pages need update dates rather than evergreen confidence.',
      },
      {
    ...
    routeChecklist: [
      'Track Tadpole-related patch notes before long routes.',
    ...
    routeSteps: [
      ...
      },
      {
        ...
        body: 'Hotfix 2 adjusted Hammerheads so they are no longer as attracted to Tadpole lights. That is exactly the kind of practical note players need.',
      },
      {
    ...
    tableRows: [
      ...
      [
        ...
        'Explain route use, light risk, docking checks, and known hotfix mentions.',
      ],
      [
      ...
      [
        ...
        'Point readers to Hotfix 2 before giving old workarounds.',
      ],
    ],
    ...
    visualItems: [
      ...
      },
      {
        label: 'Patch risk',
        value: 'High',
        note: 'Hotfixes already touched Tadpole behavior.',
      },
      {
        label: 'Future',
        value: 'Watch',
    ...
    faqs: [
      {
        ...
        body: 'Track the Tadpole first because official hotfix notes already mention Tadpole lights, exploration, and piloting bugs.',
      },
      {
      ...
      },
      {
        ...
        body: 'Hotfix 2 mentions Hammerheads following players back toward bases because of Tadpole-light attraction, and says that behavior was adjusted.',
      },
      {
    ...
    sourceBody:
      'Checked June 1, 2026 against Unknown Worlds Hotfix 2, the Early Access roadmap, Steam, and the official trailer. Page art is original Abyss Guides art; video is the official Subnautica embed.',
  ...
  zh: {
    metadata: {
      ...
      description:
        'Subnautica 2 载具中文指南：Tadpole、载具停靠、Hotfix 2 相关问题、未来载具路线图和安全路线规划。',
    },
    ...
    quickLabel: '快速结论',
    quickAnswer:
      '先关注 Tadpole。Hotfix 2 明确提到 Tadpole 灯光、Hammerhead 对 Tadpole 的行为、驾驶 Tadpole 时的传送问题和氧气问题。Unknown Worlds 也说未来大更新会扩展工具和载具，所以其他载具名先当观察项，不要当成已确认列表。',
    ...
    fieldNotes: [
      ...
      {
        title: '它也会带来新问题',
        body: 'Hotfix 2 已经修过 Tadpole 相关行为和问题，所以载具页必须有更新时间。',
      },
      {
        title: '它会影响建家',
    ...
    routeSteps: [
      ...
      {
        title: '注意灯光和生物行为',
        body: 'Hotfix 2 调整了 Hammerhead 对 Tadpole 灯光的吸引，这种细节对玩家很有用。',
      },
      {
        title: '不要夸大未来载具',
    ...
    faqs: [
      {
        ...
        body: '先关注 Tadpole，因为官方 Hotfix 2 已经提到它的灯光、探索和驾驶相关问题。',
      },
      {
        title: '以后会有更多载具吗？',
      ...
      {
        title: '生物会跟着载具回基地吗？',
        body: 'Hotfix 2 提到 Hammerhead 曾因为 Tadpole 灯光跟随玩家回基地附近，并已经调整。',
      },
      {
        title: '载具页需要视频吗？',
    ...
    sourcesTitle: '来源说明',
    sourceBody:
      '2026 年 6 月 1 日核对 Unknown Worlds Hotfix 2、抢先体验路线图、Steam 和官方预告。图片为 Abyss Guides 原创图，视频为 Subnautica 官方嵌入。',
    cardKicker: '载具观察',
