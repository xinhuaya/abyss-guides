...
const SUBNAUTICA_LAST_MODIFIED = new Date('2026-06-04');
...
const staticRoutes = [
  ...
  Routes.Subnautica2VoiceChat,
  Routes.Subnautica2Sprint,
  ...
  Routes.Subnautica2LawsuitResponse,
...
function getChangeFrequency(
  ...
  if (
    ...
    route === Routes.Subnautica2Mods ||
    route === Routes.Subnautica2VrSupport ||
    ...
    route === Routes.Subnautica2FriendCode ||
    route === Routes.Subnautica2ServerStatus ||
    route === Routes.Subnautica2InviteNotWorking ||
    route === Routes.Subnautica2OnlineServicesConnectionFailed ||
    ...
    route === Routes.Subnautica2VoiceChat ||
    route === Routes.Subnautica2Sprint ||
