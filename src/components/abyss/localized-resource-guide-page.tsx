...
const guideImageByPathname: Partial<Record<Routes, string>> = {
  ...
  [Routes.Subnautica2Map]: '/abyss/chibi-base-location.webp',
  [Routes.Subnautica2InteractiveMap]: '/abyss/chibi-base-location.webp',
  [Routes.Subnautica2Biomes]: '/abyss/chibi-base-location.webp',
  ...
  [Routes.Subnautica2AirTank]: '/abyss/chibi-crafting-bench.webp',
  [Routes.Subnautica2OxygenDepth]: '/abyss/chibi-crafting-bench.webp',
  ...
  [Routes.Subnautica2Rebreather]: '/abyss/chibi-crafting-bench.webp',
  ...
  [Routes.Subnautica2Coop]: '/abyss/chibi-platform-briefing.webp',
  [Routes.Subnautica2CoopPlayerCount]: '/abyss/chibi-platform-briefing.webp',
  [Routes.Subnautica2Crossplay]: '/abyss/chibi-platform-briefing.webp',
  [Routes.Subnautica2MultiplayerNotWorking]:
    '/abyss/chibi-platform-briefing.webp',
  [Routes.Subnautica2Updates]: '/abyss/chibi-platform-briefing.webp',
  ...
  [Routes.Subnautica2Hotfix2]: '/abyss/chibi-platform-briefing.webp',
  [Routes.Subnautica2SilverAfterHotfix2]: '/abyss/chibi-resource-scan.webp',
  [Routes.Subnautica2TroiliteAfterHotfix2]: '/abyss/chibi-resource-scan.webp',
};
